...
public class ServiceConfig {
    ...
    @Bean
    public BroadcastService broadcastService(BroadcastLogRepository logRepository,
    ...
    @Bean
    public EventUpdateService eventUpdateService(EventUpdateRepository updateRepository,
                                                 EventRepository eventRepository,
